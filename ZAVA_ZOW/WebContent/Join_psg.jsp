		...
		<div id="content">
			...
			<form action="joinCon" method="post">
				...
				<div>
					...
					<input type="text" id="name" name="nick" class="int" maxlength="20">
					</span>
					<span class="error_next_box"></span>
				</div>
				...
				<div>
					...
					<div id="bir_wrap">
						...
						<!-- BIRTH_MM -->
						<div id="bir_mm">
							<span class="box"> <select id="mm" name="birth_mm" class="sel">
									<option>월</option>
				...
				<div>
					...
					<span class="box int_card">
						<input type="text" id="card_num" name="cardNum" class="int" maxlength="16" placeholder="카드번호 입력">
					</span>
				...
				<div>
					...
					<span class="box handicpped">
						<select id="handicpped" name="handi" class="sel">
							<option>장애여부</option>
