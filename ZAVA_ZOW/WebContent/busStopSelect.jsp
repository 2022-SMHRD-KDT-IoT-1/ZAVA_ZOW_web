<%@page import="org.zavazow.model.BusStopVO"%>
...
<body class="header">
	<%
		List<BusStopVO> list = (List<BusStopVO>)request.getAttribute("busStopInfo");
	%>
	<!-- Navigation -->
	<nav
	...
	<!-- content -->
	<div class="container container-md bg-white" style="margin-top: 200px; height: 500px">
			...
			<tbody>
				<%
					for (int i = 0; i < list.size(); i++) {
						BusStopVO vo = list.get(i);
				%>
				<tr>
					
					<td><a href="goBusList?busStopId=<%=vo.getBusStopId() %>"><%=vo.getBusStopName()%></a></td>
					<td><%=vo.getNextBusStop()%></td>
					<td><%=vo.getBusStopId()%></td>
